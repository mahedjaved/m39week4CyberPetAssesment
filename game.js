...
// increase memory for 'if' statements looping to avoid the warning :: max listeners exceeded warning
...
async function start(Cat, Dog, Hamster) {
...
async function userChoice() {
    ...
    // death and attribute fixing based if statements
    if (myPet.health > 50) {
        myPet.health = 50;
    }
...
// Abandoned attempt at dropping health attributes at set intervals

// healthDrain(); {
//     setInterval(() => { myPet.health -= 5 }, 10000),
// }

// nutritionDrain() {
//     setInterval(() => { myPet.nutrition -= 5 }, 10000)
// }

// hydrationDrain() {
//     setInterval(() => { myPet.hydration -= 5 }, 10000)
// }

// excitementDrain() {
//     setInterval(() => { myPet.excitement -= 5 }, 10000)
// }

// staminaDrain() {
//     setInterval(() => { myPet.stamina -= 5 }, 10000)
// }